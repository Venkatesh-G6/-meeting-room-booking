...
public class SwaggerConfig {
    ...
    @Bean
    public OpenAPI roomBookingOpenAPI() {
        ...
        SecurityScheme oauth2Scheme = new SecurityScheme()
                ...
                .flows(new OAuthFlows()
                        .authorizationCode(new OAuthFlow()
                                ...
                                .tokenUrl(tokenUrl)
                                .scopes(new Scopes()
                                        .addString(appIdUri + "/.default", "Access the Meeting Room Booking API"))));

        return new OpenAPI()
                .info(new Info()
                        .title("Meeting Room Booking System")
                        .description("REST API for managing room bookings with Microsoft Entra ID auth")
                        .version("1.0"))
